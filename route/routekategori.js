...
const getkategoriall = app.get("/kategori", async(req, res) => {
...
const getkategoriid = app.get("/kategori/:id", async(req, res) => {
...
const createkategori = app.post("/kategori", async(req, res) => {
    let response = {};
    const body = req.body;
      try {
 ...
 const updatekategori = app.put("/kategori/:id", async(req, res) => {
     let response = {};
 ...
 const deletekategori = app.delete("/kategori/:id", async(req, res) => {
     try {
